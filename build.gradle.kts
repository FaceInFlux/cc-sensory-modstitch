...
modstitch {
    ...
    metadata {
        ...
        modName = "CC Sensory"
        modVersion = "1.0.0"
        modGroup = "io.github.FaceInFlux"
        modAuthor = "FaceInFlux"
...
//
//        configs.register("ccsensory")
//
//        // Most of the time you wont ever need loader specific mixins.
//        // If you do, simply make the mixin file and add it like so for the respective loader:
//        // if (isLoom) configs.register("ccsensory-fabric")
//        // if (isModDevGradleRegular) configs.register("ccsensory-neoforge")
//        // if (isModDevGradleLegacy) configs.register("ccsensory-forge")
//    }
}
